	...
	<div class="vp_d_1">
		...
		<div class="vp_d_1_1">
			<div class="content_info">
				...
				<div class="tableH2">
					投诉详细信息<span style="color: red;">(<s:property
							value="#complainStateMap[comp.state]" />)
					</span>
				</div>
				<table id="baseInfo" width="100%" align="center" class="list"
					...
					<tr>
						...
						<td><s:date name="comp.compTime" format="yyyy-MM-dd HH:mm" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><s:iterator value="comp.complainReplies"
								status="st">
								<fieldset style="border: solid 1px #c0c0c0; margin-top: 5px;">
									...
									<div
										...
										回复部门：
										<s:property value="replyDept" />
										&nbsp;&nbsp; 回复人：
										<s:property value="replyer" />
										&nbsp;&nbsp; 回复时间：
